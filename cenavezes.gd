...
@onready var animacaovezes = $Vezes/AnimatedSprite2D
...
func _ready() -> void:
	...
	load_stats()  # ← CARREGA valores do stats.txt
...
# =============================================
#   LÊ valores do arquivo stats.txt
# =============================================
func load_stats():
...
func load_quiz() -> void:
	...
	if vidaboss == 0:
		get_tree().change_scene_to_file("res://combatedivisao.tscn")
