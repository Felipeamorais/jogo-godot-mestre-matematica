...
@onready var animacaomenos = $Menos/AnimatedSprite2D
...
func load_quiz() -> void:
	...
	if vidaboss == 0:
		get_tree().change_scene_to_file("res://combatevezes.tscn")
